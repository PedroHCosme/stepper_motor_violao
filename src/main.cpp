...
void setup()
{
  ...
  guitar.insertMotor('E', 14, 12);
  guitar.insertMotor('A', 26, 27);
  guitar.insertMotor('D', 33, 25);
  guitar.insertMotor('G', 4, 2);
  guitar.insertMotor('B', 5 , 18);
...
void loop()
{
  string musicaLegal = "V<45>\nS<1>\n1<BDGEA d s >";
  guitar.parseFile(musicaLegal,0 );
  //engineTest.oneStep(20);
/**
  switch (targetScreen)
  {
  case 1:
